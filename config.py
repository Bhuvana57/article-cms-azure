...
class Config(object):
    ...
    CLIENT_SECRET = "yGz8Q~vJy1tCiF_QPpq5rzT5Egc9XHcTpDuBKamD"
    ...
    AUTHORITY = "https://login.microsoftonline.com/2cb8e7e1-b13d-4031-a0a8-e932452e6249"  # For multi-tenant app, else put tenant name
    # AUTHORITY = "https://login.microsoftonline.com/Enter_the_Tenant_Name_Here"

    CLIENT_ID = "401f4005-3945-4f90-ba36-df9156d21136"
